...
const Features = () => {
  return (
    <>
      <div className="sm:mt-28 mt-20 max-w-md sm:max-w-2xl mx-auto">
        <div className="">
          ...
          <p className="mt-7 text-[15px] font-roboto text-[#4b71a6] text-justify">
            ...
            astfel un efect imediat de bucurie si buna dispozitie, atat pentru
            cel ce il primeste cat si pentru toti cei prezenti.
          </p>
        </div>
        ...
        <div className="mt-12">
          ...
          <p className="mt-7 text-[15px] font-roboto text-[#4b71a6]  text-justify">
            ...
            dintre cel ce daruiesteste si cel ce primeste. Poate exprima
            dragoste, recunostinta, prietenie sau simpatie unind distantele si
            intarind legaturile, aducand astfel bucurie atat celui care ofera,
            cat si celui care primeste. Si asta pentru ca semnificatia unui dar
            consta nu numai in valoarea sa materiala, ci si in sentimentul si
            sensul din spatele lui. Cu toate acestea in gand am conceput Ikigon,
            un cadou personalizat si un concept unic ce intruneste toate
            conditiile unui cadou cu un real succes.
          </p>
        </div>
      </div>
      <div className="max-w-md sm:max-w-2xl mx-auto">
        <div className="mt-16 ">
          <h1 className="text-[#264aa7] font-semibold sm:text-[25px] text-[22px] font-poppins ">
            Evenimente unde poti sa oferi un Ikigon
          </h1>
        </div>

        <div className="w-full flex sm:flex-row flex-col mt-12 items-center justify-center ">
          <div className="py-10 sm:w-1/2  flex justify-start items-center">
            <img
              src={img1}
              alt=""
          ...
          <div className="sm:w-1/2">
            ...
            <p className="mt-2 text-[#4b71a6] text-[15px] font-roboto ">
              ...
              dezvoltarea impreuna si promisiunea unei prietenii de durata
            </p>
          </div>
        </div>

        <div className="w-full flex sm:flex-row flex-col mt-12 items-center justify-center ">
          <div className="py-10 sm:w-1/2 sm:order-2 flex justify-end items-center">
            <img
              src={img2}
              alt=""
              className="w-56 h-56 rounded-full object-cover"
          ...
          <div className="sm:w-1/2">
            ...
            <p className="mt-2 text-blue-700 text-lg ">
              ...
              portretelor va deveni una dintre atractiile serii dar si o sursa
              de viralizare
            </p>
          </div>
        </div>
        ...
        <div className="w-full flex sm:flex-row flex-col mt-12 items-center justify-center ">
          ...
          <div className="sm:w-1/2">
            ...
            <p className="mt-2 text-blue-700 text-lg ">
              ...
              surpriza transmitand un sentiment profund si sincer
            </p>
          </div>
        </div>
        ...
        <div className="w-full flex sm:flex-row flex-col mt-12 items-center justify-center ">
          ...
          <div className="sm:w-1/2">
            ...
            <p className="mt-2 text-blue-700 text-lg ">
              ...
              incurajare pentru eforturile viitoare.
            </p>
          </div>
        </div>
